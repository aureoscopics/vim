...
" Blue Prime                  #40BDFF
" Blue Secondary              #1d73c9
" Blue Tertiary               #7a9bc2
...
hi Normal                     guifg=#aec2e0 guibg=#14191f gui=NONE      ctermfg=250
hi NonText                    guifg=#88fefe guibg=NONE    gui=NONE      ctermfg=008
hi Comment                    guifg=#526479 guibg=NONE    gui=NONE      ctermfg=243
hi Constant                   guifg=#40BDFF guibg=NONE    gui=NONE      ctermfg=039
hi Directory                  guifg=#40BDFF guibg=NONE    gui=NONE      ctermfg=039
hi Identifier                 guifg=#d0dfe6 guibg=NONE    gui=NONE      ctermfg=246
hi PreProc                    guifg=#d0dfe6 guibg=NONE    gui=NONE      ctermfg=246
hi Special                    guifg=#aec2e0 guibg=NONE    gui=NONE      ctermfg=255
hi Statement                  guifg=#aec2e0 guibg=NONE    gui=NONE      ctermfg=250
hi Title                      guifg=#aec2e0 guibg=NONE    gui=bold      ctermfg=250
hi Type                       guifg=#7a9bc2 guibg=NONE    gui=NONE      ctermfg=039
hi SpecialKey                 guifg=#40BDFF guibg=NONE    gui=NONE      ctermfg=039
hi Conditional                guifg=#7a9bc2 guibg=NONE    gui=NONE      ctermfg=039
hi Operator                   guifg=#d0dfe6 guibg=NONE    gui=NONE      ctermfg=246
hi Exception                  guifg=#7a9bc2 guibg=NONE    gui=NONE      ctermfg=039
hi Label                      guifg=#7a9bc2 guibg=NONE    gui=NONE      ctermfg=039
hi Repeat                     guifg=#7a9bc2 guibg=NONE    gui=NONE      ctermfg=039
hi Keyword                    guifg=#7a9bc2 guibg=NONE    gui=NONE      ctermfg=039
hi String                     guifg=#40BDFF guibg=NONE    gui=NONE      ctermfg=039
hi Character                  guifg=#d0dfe6 guibg=NONE    gui=NONE      ctermfg=039
hi Boolean                    guifg=#40BDFF guibg=NONE    gui=NONE      ctermfg=039
hi Number                     guifg=#40BDFF guibg=NONE    gui=NONE      ctermfg=039
hi Function                   guifg=#0ff4e1 guibg=NONE    gui=NONE      ctermfg=255
hi Underlined                 guifg=#aec2e0 guibg=NONE    gui=underline ctermfg=250
...
hi Cursor                     guifg=#6A6A6A guibg=#0ff4e1 gui=NONE      ctermfg=008   ctermbg=255
hi CursorIM                   guifg=#14191f guibg=#aec2e0 gui=NONE      ctermfg=008   ctermbg=255
...
hi Visual                     guifg=#0ff4e1 guibg=#183c66 gui=NONE      ctermfg=255   ctermbg=008
hi VisualNOS                  guifg=#0ff4e1 guibg=#183c66 gui=NONE      ctermfg=255   ctermbg=008
hi IncSearch                  guifg=#0ff4e1 guibg=#7a9bc2 gui=NONE      ctermfg=255   ctermbg=039
hi MatchParen                 guifg=#14191f guibg=#40BDFF gui=NONE      ctermfg=235   ctermbg=039
hi Search                     guifg=#0ff4e1 guibg=#40BDFF gui=NONE      ctermfg=255   ctermbg=039
...
if s:accent == "red"
  hi IncSearch                guifg=#0ff4e1 guibg=#C5282F gui=NONE      ctermfg=255   ctermbg=001
  hi MatchParen               guifg=#14191f guibg=#FF3D23 gui=NONE      ctermfg=235   ctermbg=001
  hi Search                   guifg=#FFFFFF guibg=#FF3D23 gui=NONE      ctermfg=255   ctermbg=001
endif

if s:accent == "green"
  hi IncSearch                guifg=#14191f guibg=#65910F gui=NONE      ctermfg=255   ctermbg=002
  hi MatchParen               guifg=#14191f guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  hi Search                   guifg=#14191f guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
endif

if s:accent == "yellow"
  hi IncSearch                guifg=#14191f guibg=#C3BA4D gui=NONE      ctermfg=255   ctermbg=226
  hi MatchParen               guifg=#14191f guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
  hi Search                   guifg=#14191f guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
endif

if s:accent == "orange"
  hi IncSearch                guifg=#FFFFFF guibg=#FBBE1C gui=NONE      ctermfg=255   ctermbg=208
  hi MatchParen               guifg=#14191f guibg=#C88623 gui=NONE      ctermfg=235   ctermbg=208
...
if s:accent == "purple"
  ...
  hi MatchParen               guifg=#14191f guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
...
hi Question                   guifg=#7a9bc2 guibg=NONE    gui=NONE      ctermfg=039   ctermbg=NONE
...
hi ColorColumn                guifg=#aec2e0 guibg=#292929 gui=bold      ctermfg=250   ctermbg=008
hi Pmenu                      guifg=#0ff4e1 guibg=#14191f gui=NONE      ctermfg=255   ctermbg=000
hi PmenuSel                   guifg=#0ff4e1 guibg=#40BDFF gui=NONE      ctermfg=255   ctermbg=039
hi PmenuThumb                 guifg=#0ff4e1 guibg=#40BDFF gui=NONE      ctermfg=255   ctermbg=039
hi StatusLine                 guifg=#aec2e0 guibg=NONE    gui=NONE      ctermfg=250   ctermbg=NONE
hi StatusLineNC               guifg=#aec2e0 guibg=NONE    gui=NONE      ctermfg=250   ctermbg=NONE
hi CursorLineNr               guifg=#aec2e0 guibg=#292929 gui=bold      ctermfg=255   ctermbg=NONE    cterm=bold
hi TabLine                    guifg=#aec2e0 guibg=NONE    gui=NONE      ctermfg=250   ctermbg=NONE    cterm=NONE
hi TabLineFill                guifg=#aec2e0 guibg=NONE    gui=NONE      ctermfg=250   ctermbg=NONE    cterm=NONE
hi FoldColumn                 guifg=#14191f guibg=#40BDFF gui=NONE      ctermfg=235   ctermbg=039
hi Folded                     guifg=#14191f guibg=#40BDFF gui=NONE      ctermfg=235   ctermbg=039
hi LineNr                     guifg=#6A6A6A guibg=#0F0F0F gui=NONE      ctermfg=245   ctermbg=000
hi SignColumn                 guifg=#7a9bc2 guibg=NONE    gui=NONE      ctermfg=255   ctermbg=NONE
hi VertSplit                  guifg=#50b0f2 guibg=NONE    gui=NONE      ctermfg=246   ctermbg=000
hi WildMenu                   guifg=#14191f guibg=#40BDFF gui=NONE      ctermfg=235   ctermbg=039
hi OverLength                 guifg=NONE    guibg=#20272F gui=NONE      ctermfg=NONE  ctermbg=018

if s:background == "eighties"
  hi CursorLineNr             guifg=#aec2e0 guibg=#111111 gui=bold      ctermfg=255   ctermbg=NONE    cterm=bold
  hi LineNr                   guifg=#6A6A6A guibg=#2D2D2D gui=NONE      ctermfg=245   ctermbg=232
endif

if s:accent == "red"
  hi PmenuSel                 guifg=#0ff4e1 guibg=#FF3D23 gui=NONE      ctermfg=255   ctermbg=001
  hi PmenuThumb               guifg=#0ff4e1 guibg=#FF3D23 gui=NONE      ctermfg=255   ctermbg=001
  hi FoldColumn               guifg=#14191f guibg=#FF3D23 gui=NONE      ctermfg=235   ctermbg=001
  hi Folded                   guifg=#14191f guibg=#FF3D23 gui=NONE      ctermfg=235   ctermbg=001
  hi WildMenu                 guifg=#14191f guibg=#FF3D23 gui=NONE      ctermfg=235   ctermbg=001
  hi OverLength               guifg=NONE    guibg=#641900 gui=NONE      ctermfg=NONE  ctermbg=052
endif

if s:accent == "green"
  hi PmenuSel                 guifg=#14191f guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  hi PmenuThumb               guifg=#14191f guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  hi FoldColumn               guifg=#14191f guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  hi Folded                   guifg=#14191f guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  hi WildMenu                 guifg=#14191f guibg=#87BF19 gui=NONE      ctermfg=235   ctermbg=002
  hi OverLength               guifg=NONE    guibg=#32321E gui=NONE      ctermfg=NONE  ctermbg=022
endif

if s:accent == "yellow"
  hi PmenuSel                 guifg=#14191f guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
  hi PmenuThumb               guifg=#14191f guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
  hi FoldColumn               guifg=#14191f guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
  hi Folded                   guifg=#14191f guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
  hi WildMenu                 guifg=#14191f guibg=#DEDD5A gui=NONE      ctermfg=235   ctermbg=226
...
if s:accent == "orange"
  ...
  hi FoldColumn               guifg=#14191f guibg=#C88623 gui=NONE      ctermfg=235   ctermbg=208
  hi Folded                   guifg=#14191f guibg=#C88623 gui=NONE      ctermfg=235   ctermbg=208
  hi WildMenu                 guifg=#14191f guibg=#C88623 gui=NONE      ctermfg=235   ctermbg=208
  hi OverLength               guifg=NONE    guibg=#443A16 gui=NONE      ctermfg=NONE  ctermbg=094
endif

if s:accent == "purple"
  hi PmenuSel                 guifg=#14191f guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
  hi PmenuThumb               guifg=#14191f guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
  hi FoldColumn               guifg=#14191f guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
  hi Folded                   guifg=#14191f guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
  hi WildMenu                 guifg=#14191f guibg=#B294BB gui=NONE      ctermfg=235   ctermbg=013
...
hi DiffText                   guifg=#aec2e0 guibg=NONE    gui=bold      ctermfg=250
...
hi helpSpecial                guifg=#aec2e0 guibg=NONE    gui=NONE      ctermfg=250
hi helpHyperTextJump          guifg=#40BDFF guibg=NONE    gui=underline ctermfg=039
hi helpNote                   guifg=#aec2e0 guibg=NONE    gui=NONE      ctermfg=250
